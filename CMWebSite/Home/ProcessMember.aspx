<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessMember.aspx.cs" Inherits="CM.ProcessMember" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        var strPersonid = "<%=strPersonID%>";

        var strFamilyListOpen = "<%=szFamilyListOpen%>";
        function updateOneMember() {
            ...
            UpdateChurchMember(lastName, firstName, middleInitial, gender, DOB, homePhone, cellPhone, businessPhone, Email, Fellowship, bChristain, bCharterMember, bShowinDirectory, bActive);
         ...
         function UpdateChurchMember1(lastName) {
            debugger;
            
             $.ajax({
                type: "POST",
                url: "../JQueryAjaxProcess.aspx/UpdateChurchMember1",
        ...
        function UpdateChurchMember(lastName, firstName, middleInitial, gender, DOB, homePhone, cellPhone, businessPhone, Email, Fellowship, bChristain, bCharterMember, bShowinDirectory, bActive) {
            
            debugger;
            $.ajax({
                type: "POST",
                url: "../JQueryAjaxProcess.aspx/UpdateChurchMember",

                data: "{'strPersonid':'" + strPersonid + "','lastName':'" + lastName + "', 'firstName' : '" + firstName + "', 'middleInitial' : '" + middleInitial + "', 'gender' : '" + gender + "', 'DOB' : '" + DOB + "', 'homePhone' : '" + homePhone +
                ...
                success: function (msg) {
                    ...
                    // refresh the grid;
                    debugger;
                    if (strFamilyListOpen == "yes") {
                        // comes from family list
                        window.opener.GetFamilyMember(strFamilyID);
                    }
                    else {
                        // comes from member list
                        window.opener.GetMemberList("all");
                    }
                    window.opener.focus();
                    window.close();
...
<body>
    <form id="form1" runat="server">
           <div  class="divLayout">
        <h3 class="PageFunction">Update Member</h3>
        ...
        <table>
            <tr>
                <td >
                    <input id="btnUpdateMember" type="button" class="buttonASP" onclick="updateOneMember()" value="Update Member" />
                </td>
                 <td >

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetMemberList.aspx.cs" Inherits="CM.GetMemberList" %>
...
<body>
       <div id="repeaterContainer" >
            ...
            <ItemTemplate>
                        <tr class="reportTableRow" onclick="showMemberDetails('<%#Eval("FamilyID").ToString()%>', '<%#Eval("PersonID").ToString()%>', '<%#Eval("MemberTable").ToString()%>', 'no')" >
